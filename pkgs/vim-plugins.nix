{
  ...
  */
  nvim-plug = buildVimPlugin {
    ...
    version = "2025-03-19";
    src = fetchurl {
      url = "https://github.com/wsdjeg/nvim-plug/archive/b7a243179f3da96a47a52650e1749da92f892a89.tar.gz";
      sha256 = "0m956fhawfjqxk7mmx4592l5w0g6vnvhrdqk5gzzr05pvnwjfdar";
    };
    meta = with lib; {
